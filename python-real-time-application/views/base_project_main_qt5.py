...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(self.tab_controle_manuel)
        ...
        self.pushButton_forhonnor = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_forhonnor.setObjectName("pushButton_forhonnor")
        self.horizontalLayout_14.addWidget(self.pushButton_forhonnor)
        self.pushButton_pointer = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_pointer.setObjectName("pushButton_pointer")
        self.horizontalLayout_14.addWidget(self.pushButton_pointer)
        self.pushButton_spiderman = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_spiderman.setObjectName("pushButton_spiderman")
        self.horizontalLayout_14.addWidget(self.pushButton_spiderman)
        self.pushButton_comein = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_comein.setObjectName("pushButton_comein")
        ...
        self.pushButton_v = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_v.setObjectName("pushButton_v")
        self.horizontalLayout_16.addWidget(self.pushButton_v)
        self.pushButton_extra6 = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_extra6.setObjectName("pushButton_extra6")
        self.horizontalLayout_16.addWidget(self.pushButton_extra6)
        self.pushButton_extra7 = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_extra7.setObjectName("pushButton_extra7")
        self.horizontalLayout_16.addWidget(self.pushButton_extra7)
        self.comboBox_movimentfinal = QtWidgets.QComboBox(self.groupBox_3)
        self.comboBox_movimentfinal.setObjectName("comboBox_movimentfinal")
        ...
        self.checkBox_simulation = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_simulation.setChecked(False)
        self.checkBox_simulation.setObjectName("checkBox_simulation")
        self.verticalLayout_3.addWidget(self.checkBox_simulation)
        self.checkBox_simple_mode = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_simple_mode.setObjectName("checkBox_simple_mode")
        ...
        self.horizontalSlider_threshold = QtWidgets.QSlider(self.groupBox_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "Extra"))
        self.pushButton_forhonnor.setText(_translate("MainWindow", "For Honnor"))
        self.pushButton_pointer.setText(_translate("MainWindow", "Pointer"))
        self.pushButton_spiderman.setText(_translate("MainWindow", "Spider-Man"))
        self.pushButton_comein.setText(_translate("MainWindow", "Come In"))
        self.pushButton_v.setText(_translate("MainWindow", "V"))
        self.pushButton_extra6.setText(_translate("MainWindow", "Extra 6"))
        self.pushButton_extra7.setText(_translate("MainWindow", "Extra 7"))
        ...
        self.checkBox_simple_mode.setText(_translate("MainWindow", "Threshold"))
        self.label_2.setText(_translate("MainWindow", "2,5"))
