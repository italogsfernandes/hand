...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_output_press = QtWidgets.QPlainTextEdit(self.groupBox)
        self.txt_output_press.setMaximumSize(QtCore.QSize(800, 30))
        self.txt_output_press.setObjectName("txt_output_press")
        self.horizontalLayout_7.addWidget(self.txt_output_press)
